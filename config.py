...
parser.add_argument('--datasets', type=str, default='mirflickr25k_raw') # mirflickr25k nus_wide_tc21 MSCOCO-1, MSCOCO_doc2vec xmedia nus_wide_tc10 IAPR-TC12 wiki_doc2vec MSCOCO_bert xmedianet_full
