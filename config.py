...
parser.add_argument('--lr_update', type=int, default=50)
...
parser.add_argument('--output_shape', type=int, default=16)
...
parser.add_argument('--datasets', type=str, default='mirflickr25k_raw') # mirflickr25k nus_wide_tc21 MSCOCO_doc2vec xmedia IAPR-TC12
parser.add_argument('--epochs', type=int, default=100)
parser.add_argument('--available_num', type=int, default=100)
